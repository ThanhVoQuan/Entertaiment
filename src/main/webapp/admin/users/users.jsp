	...
	<div class="tab-content" id="myTabContent">
		...
		<div class="tab-pane fade" id="videoList" role="tabpanel"
			...
			<table class="table table-stripe">
				...
				<tr>
					<td>Nhatbt</td>
					<td>Bui Thanh Nhat</td>
					<td>thanhnhat@gmail.com</td>
					<td>Admin</td>
					<td><a href=""><i class="fa fa-edit" aria-hidden="true">
						</i>Edit</a> <a href=""><i class="fa fa-trash" aria-hidden="true"></i>Delete</a>
					</td>
				</tr>
			</table>
		</div>
