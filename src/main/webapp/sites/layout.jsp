...
<body>
	<main class="container">
		<header class="row pt-5 pb-2">
			<div class="col-9 ">
				<h1>Bui Thanh Nhat</h1>
			</div>
			<div class="col-3 text-right">
			<img src="images/Logo_FPT_Polytechnic.jpg" alt="" class="mr-4">
			</div>
		</header>
		<nav class="row">
			<nav class=" col navbar navbar-expand-sm navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavId">
					<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="#"> <i
								class="fa fa-comment" aria-hidden="true"></i> My Favorites
						</a></li>
						<li class="nav-item dropdown"><a
							...
							<c:if test="${ ! isLogin }">
								 ...
								 <a class="dropdown-item" href="Logoff">Logoff </a>
								  <a class="dropdown-item" href="change-password.html">ChangePassword </a>
								   <a class="dropdown-item" href="EditProfile">EditProfile </a>
									</c:if>
							</div>
							</li>
					</ul>
